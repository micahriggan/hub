...
var hub_client_1 = require("@centrapi/hub-client");
...
var port = hub_client_1.EnvConstants.DECENT_ENV_PORT;
app.listen(port, function () { return __awaiter(_this, void 0, void 0, function () {
    var env, service;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                env = new hub_client_1.DecentEnvClient();
                return [4, env.register({ name: 'services', port: port, host: hub_client_1.EnvConstants.DECENT_ENV_HOST })];
            case 1:
                service = _a.sent();
