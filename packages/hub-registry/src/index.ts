...
import { Service, EnvConstants, DecentEnvClient } from '@centrapi/hub-client';
import { ServiceRegistry } from './services/service-provider';
const app = express();
app.use(express.json());
app.use(cors());

const provider = new ServiceRegistry();
